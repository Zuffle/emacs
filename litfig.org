...
(use-package howm
  :defer 1
  ;; :commands (howm-menu)
  ;; TODO howm-set-keymap general-definer
  ;; :init
  ;; (gsetq howm-prefix " ah")
  ;; :hook
  ;; (howm-menu . evil-emacs-state)
  :config
  ;; (turn-off-evil-mode)
  ;; (evil-make-overriding-map action-lock-mode-map)
  (evil-set-initial-state 'howm-view-summary-mode 'emacs)
  (evil-set-initial-state 'howm-view-contents-mode 'emacs)
  ;; (add-to-list 'evil-collection-mode-list 'howm-view-summary-mode)
